...
public class KakaoPay {
	...
	public String kakaoPayReady(int count) {
		...
		// 프론트 주소나오면 다시 작성해야함
		params.add("approval_url", "http://j3b102.p.blocker.io/"); // 결제 성공시 redirect할 url
		params.add("cancel_url", "http://j3b102.p.blocker.io:8080"); // 결제 취소시 redirect할 url (결제 페이지로 바꿀 예정)
		params.add("fail_url", "http://j3b102.p.blocker.io:8080"); // 결제 실패시 redirect할 url (결제 페이지로 바꿀 예정)
