...
// var sock = new SockJS("http://j3b102.p.blocker.io:8080/api/notice");
...
//           // sock = new SockJS("http://j3b102.p.blocker.io:8080/api/ws-stomp");
//           ws = Stomp.over(sock);
//           connection();
//         }, 10 * 1000);
//       }
        ...
        function (error) {
          ...
          if (reconnect++ <= 5) {
            setTimeout(function () {
              ...
              // sock = new SockJS("http://j3b102.p.blocker.io:8080/api/notice");
              ws = Stomp.over(sock);
              connect();
            }, 10 * 1000);
          }
